...
describe PodcastReader do
  it 'should have a VERSION constant' do
    PodcastReader.const_get('VERSION').should_not be_empty
  end
  ...
  context 'with a valid podcast url' do
    it 'should have standard podcast attributes' do
      podcast = PodcastReader.new('http://podcasts.example.com/valid.xml')
    ...
    it 'should have the itunes podcast attributes' do
      podcast = PodcastReader.new('http://podcasts.example.com/valid_with_itunes.xml')
    ...
    it 'should be valid without the itunes podcast attributes' do
      podcast = PodcastReader.new('http://podcasts.example.com/valid_without_itunes.xml')
    ...
    it 'should be valid without podcast items' do
      podcast = PodcastReader.new('http://podcasts.example.com/valid_without_items.xml')
    ...
    context 'with a podcast item' do
      ...
      it 'should be valid without the itunes item attributes' do
        podcast = PodcastReader.new('http://podcasts.example.com/valid_with_items_without_itunes.xml')
        item = podcast.items.first
    ...
    context 'updated since' do
      it 'will confirm if a newer version has been released' do
        podcast = PodcastReader.new('http://podcasts.example.com/valid_future.xml')
      ...
      it 'will confirm if a newer version has NOT been released' do
        podcast = PodcastReader.new('http://podcasts.example.com/valid_past.xml')
